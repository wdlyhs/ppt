...
E_D("replace into `xia_webset` values('25','webname','五彩办公','2');");
E_D("replace into `xia_webset` values('26','url','www.ppt.com','2');");
...
E_D("replace into `xia_webset` values('72','banquan','<a href=\"http://www.beian.miit.gov.cn\" target=\"_blank\" rel=\"nofollow\"><i class=\"lazy gov-icon gov-icon-icp\" data-original=\"//static.tukuppt.com/common/image/govemblem.png\"></i><span>沪ICP备17039466号</span></a> <a href=\"http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=31010402005121\" target=\"_blank\" rel=\"nofollow\"><i class=\"lazy gov-icon gov-icon-wa\" data-original=\"//static.tukuppt.com/common/image/govemblem.png\"></i><span>沪公网安备 31010402005121号</span></a> <span class=\"tukuppt-right\">五彩办公-Copyright © 2019 版权所有</span>','0');");
...
E_D("replace into `xia_webset` values('156','wap_banquan','<p>\r\n	此作品是由五彩办公签约设计师设计上传，熊猫办公拥有版权；未经熊猫办公书面授权，请勿作他用。人物肖像，字体及音频如需商用需第三方额外授权；\r\n</p>\r\n<p>\r\n	熊猫办公尊重知识产权，如知识产权权利人认为平台内容涉嫌侵权，可通过邮件：111@tsdf.com提出书面通知，我们将及时处理。\r\n</p>\r\n<p>\r\n	网站提供的党政主题相关内容（国旗、国徽、党徽...），目的在于配合国家政策宣传，仅限个人学习分享使用，禁止用于任何广告和商用目的。\r\n</p>\r\n<p>\r\n	<br />\r\n</p>','0');");
...
E_D("replace into `xia_webset` values('164','logo','upload/2019/1031/20514782331.png','0');");
...
E_D("replace into `xia_webset` values('182','weixin','a:6:{s:5:\"appid\";s:18:\"wx8474f98f891d27e7\";s:9:\"appsecret\";s:32:\"3caba81c06421f3771facea1ea8a0fd0\";s:5:\"token\";s:0:\"\";s:6:\"aeskey\";s:0:\"\";s:6:\"sh_hao\";s:10:\"1362999602\";s:6:\"sh_key\";s:32:\"huangxiahuangxiahuangxiahuangxia\";}','1');");
...
E_D("replace into `xia_webset` values('193','qiniu','a:6:{s:5:\"appid\";s:40:\"v-WUlUmeLMI7bLZEV5N5kqbh8He0r3erib8VS9KY\";s:9:\"secretKey\";s:40:\"V_Lquhcs9vsoGeoGnO3YPbFuXvvDuH_k5vscx3KO\";s:5:\"title\";s:8:\"jiandong\";s:9:\"accessKey\";s:40:\"v-WUlUmeLMI7bLZEV5N5kqbh8He0r3erib8VS9KY\";s:3:\"url\";s:32:\"http://q02e5it4y.bkt.clouddn.com\";s:6:\"status\";s:1:\"2\";}','1');");
E_D("replace into `xia_webset` values('194','lazy','template/default/images/loadone.png','0');");
E_D("replace into `xia_webset` values('195','kfq','112121','0');");
E_D("replace into `xia_webset` values('196','zfb','a:3:{s:5:\"appid\";s:16:\"2088531019256950\";s:9:\"appsecret\";s:32:\"hkeyox1cv00l3is38ga85l8018krfcbg\";s:2:\"zh\";s:15:\"yg21hxj@163.com\";}','1');");
E_D("replace into `xia_webset` values('197','blogo','https://static.tukuppt.com/common/image/footlogo.png','0');");
E_D("replace into `xia_webset` values('198','ad1','a:2:{s:3:\"vip\";s:47:\"https://static.tukuppt.com/vip/image/banner.jpg\";s:3:\"pay\";s:34:\"template/default/images/payall.jpg\";}','1');");
