...
E_D("replace into `xia_webset` values('25','webname','manner猫呢','2');");
E_D("replace into `xia_webset` values('26','url','www.cat.com','2');");
...
E_D("replace into `xia_webset` values('72','banquan','<strong>重庆健康运营助手</strong>&nbsp;版权所有 2019','0');");
