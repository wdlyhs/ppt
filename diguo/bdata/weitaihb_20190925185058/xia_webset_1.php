...
E_D("replace into `xia_webset` values('25','webname','深圳市伟泰环保工程有限公司','2');");
E_D("replace into `xia_webset` values('26','url','www.weitaihb.com','2');");
...
E_D("replace into `xia_webset` values('72','banquan','<strong>深圳市伟泰环保工程有限公司</strong>&nbsp;版权所有 2019','0');");
...
E_D("replace into `xia_webset` values('150','tel','0755-28160132','0');");
...
E_D("replace into `xia_webset` values('155','address','深圳市宝安区石龙大道三民工业园','0');");
E_D("replace into `xia_webset` values('156','wap_banquan','我们的目标：促进猫福利以及传播教育、知识、兴趣等，带动纯种猫、饲养者、拥有者、参展商共同发展 <br />\r\n我们的使命：提供高效、准确、专业的品质服务于纯种猫事业<br />\r\n我们的猫：推广的最大利益及纯种猫的饲养者、参展商等；宣传、教育，普及知识和兴趣。','0');");
...
E_D("replace into `xia_webset` values('164','logo','upload/2019/0922/21370844216.png','0');");
...
E_D("replace into `xia_webset` values('182','weixin','wx12121','0');");
...
E_D("replace into `xia_webset` values('186','pl','2','0');");
E_D("replace into `xia_webset` values('187','user_img','https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=2520684450,3363122030&fm=26&gp=0.jpg','0');");
E_D("replace into `xia_webset` values('188','r_img','upload/2019/0922/16185772270.jpg','0');");
E_D("replace into `xia_webset` values('189','r_img_url','http://www.sina.com','0');");
E_D("replace into `xia_webset` values('190','wx_img','http://wfxnew.leiang-ele.com/themes/default/statics/img/ewm.png','0');");
E_D("replace into `xia_webset` values('191','code','355002','0');");
E_D("replace into `xia_webset` values('192','aimg','upload/2019/0925/18403653961.jpg','0');");
