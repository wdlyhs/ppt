...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              <td width="20%">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="<?=u(MOD,'addedi')?>" class="link3">[新增类型]</a> </strong></td>
      ...
      <form name="form2" method="get" action="" style="margin:0px; padding:0px">
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0  bordercolor="#dddddd">
                   ...
                   <td><?=$r["title"]?></td>
                                                <td><?
                          $temp= date_type();
						  echo $r["date_num"].$temp[$r['date_type']];
						?></td>
                        
                        
                        
                       <td><?=($r["day_xiazai_num"])?$r["day_xiazai_num"]."次":"无限制"?></td>
                        <td><?=$r["price"]?></td>
					    <td><?=$r["yprice"]?></td>
