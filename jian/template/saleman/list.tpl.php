...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              <td width="20%">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="<?=u(MOD,'addedi')?>" class="link3">[新增业务员]</a> </strong></td>
              <td width="" align="right">产品列表：<?=select($parr,$_GET['pid'],'pid')?>&nbsp;姓名：<input type="text" name="q" value="<?=$q?>" />&nbsp;<input type="submit" value="搜索" /></td>
                  ...
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0  bordercolor="#dddddd">
					...
					<?php foreach ($row as $r){?>
					  <tr>
                        ...
                        <td><?=$r["title"]?></td>
						 <td><?=SITEURL?>/index.php?rec=<?=$r['id']?></td>
                        <td><a href="<?=u(MOD,"ewm",array("id"=>$r['id']))?>">查看</td>
                        <td><?=hnum($r['id'],$_GET['pid'])?></td>
