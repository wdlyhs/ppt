...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              ...
              <td width="" align="right">类型：<?=select(array(0=>"全部",1=>"收藏",2=>"点赞"),$_GET['type'],'type')?>&nbsp;<input type="submit" value="搜索" /></td>
                  ...
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0  bordercolor="#dddddd">
					...
					foreach ($row as $r){
					  ...
					  <tr>
                        ...
                        <td>
                          <a target="_blank"  href="../<?=u("product","view",array("id"=>$r['id']))?>"><?=get_str(get_title("product",$r['pid']),25)?></a>
                        </td>
						 <td><?=get_title("user",$r['uid'],"ddusername")?></td>
                        <td><?=($r['type']==1)?"收藏":"点赞"?></td>
