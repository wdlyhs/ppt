...
<tr>
    <td align="right">默认头像：</td>
    <td>&nbsp;<input name="default_img" type="text" id="default_img" value="<?=$webset['default_img']?>" style="width:300px" /> <input class="sub" type="button" value="上传图片" onclick="javascript:openpic('<?=u('fun','upload',array('uploadtext'=>'default_img','sid'=>session_id()))?>','upload','450','350')" /> <span class="zhushi">可直接添加网络地址(100*100)</span></td>
  </tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input name="logo" type="text" id="logo" value="<?=$webset['logo']?>" style="width:300px" /> <input class="sub" type="button" value="上传图片" onclick="javascript:openpic('<?=u('fun','upload',array('uploadtext'=>'logo','sid'=>session_id()))?>','upload','450','350')" /> <span class="zhushi"></span></td>
  </tr>
  
  <tr>
    <td align="right">加载图：</td>
    <td>&nbsp;<input name="lazy" type="text" id="lazy" value="<?=$webset['lazy']?>" style="width:300px" /> <input class="sub" type="button" value="上传图片" onclick="javascript:openpic('<?=u('fun','upload',array('uploadtext'=>'lazy','sid'=>session_id()))?>','upload','450','350')" /> <span class="zhushi">160*98</span></td>
  </tr>
  <tr>
    <td align="right">底部透明LOGO：</td>
    <td>&nbsp;<input name="blogo" type="text" id="blogo" value="<?=$webset['blogo']?>" style="width:300px" /> <input class="sub" type="button" value="上传图片" onclick="javascript:openpic('<?=u('fun','upload',array('uploadtext'=>'blogo','sid'=>session_id()))?>','upload','450','350')" /> <span class="zhushi"></span></td>
  </tr>
 ...
 <!-- <tr>
    ...
    <td>&nbsp;<input name="wx_img" type="text" id="wx_img" value="<?=$webset['wx_img']?>" style="width:300px" /> <input class="sub" type="button" value="上传图片" onclick="javascript:openpic('<?=u('fun','upload',array('uploadtext'=>'wx_img','sid'=>session_id()))?>','upload','450','350')" /> <span class="zhushi"></span></td>
  </tr>-->
 ...
 <!--<tr>
    ...
    <td>&nbsp;<input name="address" type="text" value="<?=$webset['address']?>" class="btn3" style="width:400px" /> <span class="zhushi">建议不超过5个汉字</span>
  </td>
  </tr> 
  <tr>
    <td align="right">邮箱：</td>
    <td>&nbsp;<input name="email" type="text" value="<?=$webset['email']?>" class="btn3" style="width:400px" /> <span class="zhushi"></span>
  </td>
  </tr>
  -->
  ...
  <tr>
    ...
    <td>&nbsp;<input name="tel" type="text" value="<?=$webset['tel']?>" class="btn3"  /> <span class="zhushi"></span>
  </td>
  </tr>
  ...
  <tr>
    ...
    <td>&nbsp;<input name="qq" type="text" value="<?=$webset['qq']?>" class="btn3"  /> <span class="zhushi"></span>
  </td>
  </tr>
  
  
  <tr>
    <td align="right">客服群：</td>
    <td>&nbsp;<input name="kfq" type="text" value="<?=$webset['kfq']?>" class="btn3"  /> <span class="zhushi"></span>
  </td>
  </tr>
  <tr>
    <td align="right">客服群key：</td>
    <td>&nbsp;<input name="kfq_key" type="text" value="<?=$webset['kfq_key']?>" class="btn3"  /> <span class="zhushi"></span>
  </td>
  </tr>
  ...
  <tr>
    <td height="50" align="right">产品页版权：</td>
    <td height="50" style="padding:5px 13px;"><textarea name="wap_banquan" id="wap_banquan" style="width:680px;"><?=$webset['wap_banquan']?></textarea></td>
  </tr>
