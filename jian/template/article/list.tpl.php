...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              ...
              <td width="" align="right">推荐：<?=select($tj_arr,$_GET['tj'],'tj')?>&nbsp;<select name="cid" style="font-size:12px"><option value="0">--顶层栏目--</option><?php getCategorySelect($cid,0,0);?></select>&nbsp;标题：<input type="text" name="q" value="<?=$q?>" />&nbsp;<input type="submit" value="搜索" /></td>
                  ...
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
					...
					<?php foreach ($row as $r){?>
					  <tr>
                        ...
                        <td style="text-align:left; padding-left:5px"><a href="../<?=u(MOD,'view',array('id'=>$r['id']))?>" target="_blank"><?=($r['tj']==2)?"<font color='red'>[推荐]</font>":""?><?=$r["title"]?></a></td>
