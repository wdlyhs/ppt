...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              <td width="20%">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="<?=u(MOD,'addedi')?>" class="link3">[新增评论]</a> </strong></td>
                  ...
                  <table id="listtable" border=1 cellpadding=0 cellspacing=0  bordercolor="#dddddd">
					...
					<?php foreach ($row as $r){?>
					  <tr>
                        ...
                        <td><?=get_name($r["title"])?></td>
						<td><?
                        $title=$duoduo->select("article","title","id=".$r['aid']);
						if (empty($title))
						    echo "没有对应文章";
							else
						     echo get_str($title,20);
						?></td>
                     
                      <td><?=($r['is_show']==1)?"未显示":"显示"?></td>
