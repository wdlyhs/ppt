...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              <td width="20%">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="javascript:;" class="link3">[订单列表]</a> </strong></td>
                       ...
                       <td><?=$r["order_sn"]?></td>
                        <td><?=$r["title"]?></td>
                         <td><?=$r["price"]?></td>
                          <td>
                         <?
                         $name=$duoduo->select("user","ddusername","id=".$r['uid']);echo $name;
						 ?></td>
                          <td><?=($r["type"]==1)?"微信":"支付宝"?></td>
                         <td><?=($r['status']==1)?"未付款":"已付款"?></td>
