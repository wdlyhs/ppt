...
<table cellspacing="0" width="100%" style="border:1px  solid #DCEAF7; border-bottom:0px; background:#E9F2FB;">
        <tr>
              <td width="20%">&nbsp;<img src="images/arrow.gif" width="16" height="22" align="absmiddle" />&nbsp;<a href="<?=u(MOD,'addedi',array("aid"=>$_GET['aid']))?>" class="link3">[新增属性值]</a> </strong></td>
					...
					<?php foreach ($row as $r){?>
					  <tr>
                        ...
                        <td><?=$r["title"]?></td>
                         ...
                         <td><?=get_title("attribute",$r['aid'])?></td>
                         <td><?=get_title("aitems",$r['aaid'])?></td>
                         	<td class="input" field='sort' w='50' tableid="<?=$r["id"]?>" status='a' title="双击编辑"><?=$r["sort"]==DEFAULT_SORT?'——':$r["sort"]?></td>
						<td>
                     
                        <a href="<?=u(MOD,'addedi',array('id'=>$r['id'],'aid'=>$r['aid']))?>" class=link4>修改</a></td>
					  </tr>
					<?php }?>
                  </table>
