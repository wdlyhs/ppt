...
$(function(){
	...
	$('#bmstime').calendar({format:'yyyy-MM-dd'}); 
	$('#bmetime').calendar({format:'yyyy-MM-dd'});
	
	$('#tpstime').calendar({format:'yyyy-MM-dd'}); 
	$('#tpetime').calendar({format:'yyyy-MM-dd'});
	
	$('#shstime').calendar({format:'yyyy-MM-dd'}); 
	$('#shetime').calendar({format:'yyyy-MM-dd'});
	...
	if($('#content').length>0){   
	    ...
	    editor = KindEditor.create('#content',editorSets);
		 editor = KindEditor.create('#content1',editorSets);
	
		 editor = KindEditor.create('#wap_banquan',editorSets);
	}
