...
<table id="addeditable"  align="center" border=1 cellpadding=0 cellspacing=0 bordercolor="#dddddd">
  ...
  <tr>
    ...
    <td>&nbsp;<input name="mod" type="text" id="title" value="<?=$row['mod']?>" style="width:300px" /></td>
  </tr>
  
  <tr>
    <td width="115px" align="right">行为：</td>
    <td>&nbsp;<input name="act" type="text" id="title" value="<?=$row['act']?>" style="width:300px" /></td>
  </tr>
