...
$newmenu =  array(
  		"button"=>
    			array(
    				...
    				array('type'=>'view','name'=>'商城','url'=>'http://hua.wysfanli.com'),
    				)
   		);
...
class WechatAction {
    ...
    $options = array (
          'token' => 'jian', // 填写你设定的key
        'encodingaeskey' => 'GcfQzeTd9JqppRMQtzGfIkvNs80EWyWwE6D0bwZrw4d', // 填写加密用的EncodingAESKey
        'appid' => 'wx1c2f845d88c38442', // 填写高级调用功能的app id
        'appsecret' => '25727c83467ce9266a0abc3a4b3a288d' // 填写高级调用功能的密钥
//         'partnerid' => '', // 财付通商户身份标识
...
点下方【商城首页】>>【商城登录】>>购买商品即可成为分销商，她他购物期待你们的加入，We are "伐木累"!!!';
                        ...
                        if(!empty($result1["l_id"])){
                            $text = '恭喜您由【'.$wx_info2['nickname'].'】推荐成为'.$message_name.'的第'.$result1['id'].'会位员！我们将引领您进入"消费商"的全新时代，在这里我们将与您风雨廉程，同舟同济，缔造并见证这个时代的到来。现在请您迈开在她他的第一步吧，<a style="color:blue" href="http://'.$_SERVER['HTTP_HOST'].'">点击购买</a>任一产品，您就可以成为尊贵的她他会员';
                        } else {
                            $text = '您好：欢迎您【'.$wx_info['nickname'].'】加入她他购物大家庭。
