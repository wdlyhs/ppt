            ...
            case Wechat::MSGTYPE_EVENT :
              ...
              $result4 = mysql_fetch_array($query);
                   ...
                   if(empty($result1['l_id']) && !empty($result1['member'])) {
                        $text = '恭喜您由【'.$wx_info2['nickname'].'】推荐成为'.$message_name.'的第'.$result1['id'].'位员！我们将引领您进入"消费商"的全新时代，在这里我们将与您风雨廉程，同舟同济，缔造并见证这个时代的到来。现在请您迈开在她他的第一步吧，<a style="color:blue" href="http://'.$_SERVER['HTTP_HOST'].'">点击购买</a>任一产品，您就可以成为尊贵的她他会员';
                    } else {
