            ...
            case Wechat::MSGTYPE_EVENT :
              ...
              $result4 = mysql_fetch_array($query);
                   ...
                   if(empty($result1['l_id']) && !empty($result1['member'])) {
                        $text = '恭喜您由公众号【'.$message_name.'】推荐成为'.$message_name.'的第'.$result1['id'].'位会员！2015年'.$message_name.'引领你开启“赚钱新模式”，请直接<a href="http://'.$_SERVER['HTTP_HOST'].'">点击购买</a>成为族长，一部手机，一台电脑开启您的创业之旅，让您轻轻松松赚钱!!!';
                    } else {
                        if(!empty($result1["l_id"])){
                            $text = '恭喜您由【'.$wx_info['nickname'].'】推荐成为'.$message_name.'的第'.$result1['id'].'位会员！2015年'.$message_name.'引领你开启“赚钱新模式”，请直接请直接<a href="http://'.$_SERVER['HTTP_HOST'].'">点击购买</a>成为族长，一部手机，一台电脑开启您的创业之旅，让您轻轻松松赚钱!!!';
                        } else {
