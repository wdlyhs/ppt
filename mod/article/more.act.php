...
?>
  ...
  <?  foreach ($arr as $r){
					 ?>
                  	<a href="<?=u('article','view',array('id'=>$r['id']))?>" class="news_list">

									<div class="tb">

										<div style="width:260px; overflow:hidden; text-overflow:ellipsis; white-space:nowrap"> <?=$r['title']?></div>

										<div class="date"><?=date("Y-m-d",$r['addtime'])?></div>
